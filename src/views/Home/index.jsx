            ...
            <div className="row">
              <div className="col-md-6">
                <div className="sc_banner_v3_left">
                  ...
                  >
                    Crypto<span className="flipper flip_V">Carnival</span> is a special collection of 18 essays. Written at the height of the Web3 boom, these essays from top international scholars reflect on the carnivalesque nature of Web3 in 2022, and its subsequent bust. Additionally, you can connect your Web3 wallet to play a <a href="/dice">dice game</a> or <a href="/AirdropNFT">mint an NFT</a> to
                  ...
                  <ul>
                    <li>
                      ...
                      <h4 className="counter-number">
                        <span className="counter">74,000</span>{" "}
                      </h4>
                    </li>
                    <li>
                      <h3>Tokens Minted</h3>
                      ...
                      <a href="/comingsoon">
                        <div className="previous-item hover-shape-border hover-shape-inner">
                          <div className="previous-gaming">
                            <div className="previous-price">
                              <h4 className="mb-10">
                                Immediate Gratuitousness, Squandered Energy, Useless Machines
                              </h4>
            ...
            <div className="faq_questions">
              ...
              <div className="accordion-panel">
                <p>
                  ...
                  a <a href="/comingsoon">PDF</a>. Additionally, an on chain <a href="/dice">dice</a> game) and <a href="/nftairdrop">free NFT</a>
                  can be received as a carnivalesque diversion.
                </p>
              </div>
              ...
              <div className="accordion-panel">
                <p>
                  ...
                  . These funds were used to design the Web3 website and to hire a software developer. You can receive free tokens to play
              ...
              <div className="accordion-panel">
                <p>
                  ...
                  manuscript for publication (<a href="/comingsoon">PDF</a>, see the{" "}
                  <a href="/about">colophon</a> for details).{" "}
                  <a href="/contest">Game contest submissions</a> were judged and
              ...
              <div className="accordion-panel">
                <p>
                  ...
                  tokens to play games (like our example {" "}
                  <a href="/dice">dice</a> game) or receive a <a href="/nftairdrop">free NFT</a>.
                </p>
              </div>
