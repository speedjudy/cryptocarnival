                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="sc_banner_v3_left">
                                    ...
                                    <p className="wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="0.7s">We're hard at work on the CryptoCarnival, but we need your help! This website (and the electronic book) are an experiment in web3 publication. Upon launch, NFTs will be minted, traditional publication records registered, and, to enhance the Web3 reading experience, free token-based on-chain games will be available on this website (games will require a Web3 wallet and our <a href="/faucet">free CCWTF tokens</a>). See our <a href="/dice">Dice Game</a>, for example.</p>
                                    <p>But first, to help us complete the experience, we need the Web3 community to build and contribute on-chain games for the carnival. If you have an idea and can program basic chain scripts, please <a href="/contest">JOIN THE CONTEST</a>. Winning entries will receive a small prize and everlasting fame and glory.</p>
                                </div>
                            </div>
                            <div className="col-md-6">
