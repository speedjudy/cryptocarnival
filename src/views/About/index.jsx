                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="sc_banner_v3_left">
                                    ...
                                    <p className="wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="0.7s">CryptoCarnival is a collaboration between three editors, eighteen authors, and our winning game developers. <a href="https://iqdupont.com">Quinn DuPont</a>, <a href="https://people.ucd.ie/paul.dylan-ennis">Paul Dylan-Ennis</a>, and <a href="https://people.ucd.ie/donncha.kavanagh">Donncha Kavanagh</a> are the editors. More information about our motivation is available in the <a href="comingsoon.html">Introduction</a> (coming soon).</p>
                                    <p>This website was designed and built by Quinn DuPont. It is a crude edit of a commercially available Web3 theme that was then converted into react by <a href="https://www.freelancer.com/u/denysdenysivanch">Denys</a> (<a href="https://www.freelancer.com/users/l.php?url=https:%2F%2Fwww.fiverr.com%2Fdenysdenysivanc&sig=70b8603fa3914aff1432b57239b5bbba0eb8f3586489c14a98df48755035f776">Fiverr</a>), who also minted our token, built <a href="/faucet">the faucet</a>, and created the example <a href="/dice">Dice Game</a>. The book (<a href="comingsoon.html">PDF</a>) was designed and typeset with Overleaf and LaTex.</p>
                                </div>
                            </div>
                            <div className="col-md-6">
                                ...
                                <div className="get_in_touch_contact_content">
                                    ...
                                    <div className="contact_info_content">
                                        ...
                                        <div id="donate" className="contact_info_symbol">
                                            <h5>Donate</h5>
                                            <h6>Ethereum: <a href="https://etherscan.io/address/0x9837c2370f3321C7a07927BD3819C100eF8fC20f">0x9837c2370f3321C7a07927BD3819C100eF8fC20f</a></h6>
                                            <h6>Bitcoin: <a href="https://live.blockcypher.com/btc/address/bc1pxkmr7cfy4ykxz0vz53kyz7jc8m00c95fdp6qk0rec4dcg2xg08rskwva6g/">bc1pxkmr7cfy4ykxz0vz53kyz7jc8m00c95fdp6qk0rec4dcg2xg08rskwva6g</a></h6>
                                            <h6>Binance-Peg Avalanche (BEP20): <a href="https://bscscan.com/address/0x9837c2370f3321C7a07927BD3819C100eF8fC20f">0x9837c2370f3321C7a07927BD3819C100eF8fC20f</a></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
