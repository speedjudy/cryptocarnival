                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="sc_banner_v3_left">
                                    ...
                                    <p>Until December 30th, 2022, we are running a builder's contest for the best web-based, on-chain carnival games. We want to inspire the Web3 community to design simple (optional: stupid) games that critically reflect on the carnivalesque nature of Web3 in 2022 (see our <a href="/dice">Dice Game</a> example). Winning entries will be integrated into this website alongside essays from top international scholars.</p>

                                    <p>Prize money and development funds were generously donated by the <a href="https://gitcoin.co/grants/4719/defining-web3-an-off-chain-collective-research-pr">Gitcoin community</a>.</p>
                                    ...
                                    <p>Plus you will receive everlasting fame and glory! Your game will be digitally emblazoned in the Crypto<span className="flipper flip_V">Carnival!</span></p>
                    ...
                    <div className="faq_content_sect">
                        <div className="faq_questions">
                            ...
                            <div className="accordion-panel">
                                <p>Submissions should be uploaded as a single ZIP file to this <a href="https://www.dropbox.com/request/xmAAXTUn74WD2g1i1kO3">Dropbox directory</a> by December 30th, 2022. In this ZIP file, please include all game assets and any additional links or identifying information you would like published with your game (if you want to be considered for the prize money please include your ETH wallet address). Game assets might include: chain code (Solidity, Rust, etc.), front-end code (HTML, CSS, JS), and any other assets (images, audio, etc.).</p>
                            ...
                            <div className="accordion-panel">
                                ...
                                <p>Our faucet address (Avalanche network): <a href="https://snowtrace.io/address/0xe52c7545f670c2d7723a5a306c0111829201ed10">0xe52c7545F670c2d7723A5A306c0111829201ED10</a></p>
                                <p>Your game should be web-based and self-contained enough to sit alongside written essays. Your chain code should issue a max mint or burn of 10 CCWTF per play (we will whitelist appropriate addresses). You can also issue NFTs for prizes. Get creative! If in doubt or you need technical support please <a href="/contact">contact the editors</a>.</p>
                            </div>
                            ...
                            <div className="accordion-panel">
                                <p>Any simple, web-based game is appropriate, but we look favorably upon those that engage artistically with carnivalesque aspects of Web3; such as by reflecting on the ludic, the degenerate, the excessive, the foul and rude, and the straightforward criminal. While full-page games might be suitable, we want to encourage builders to consider games built for the margins, footers, and headers of essays. Consider coordinating a theme with a particular essay! Minimally, games should require a token to play and should offer some kind of win condition. The win condition can be on-chain or off-chain: issuing CCWTF tokens, NFTs, or other digital assets. Our simple <a href="/dice">Dice Game</a> offers a basic example.</p>
                            </div>
                            ...
                            <div className="accordion-panel">
                                <p>The editors, Quinn DuPont, Paul Dylan-Ennis, and Donncha Kavanagh will evaluate the submissions and collectively choose the winners. Winners will be contacted and prize money will be disbursed.</p>
                            </div>
                            ...
                            <div className="accordion-panel">
                                <p>Our simple <a href="/dice">Dice Game</a> offers a basic example, but we encourage builders to get creative. While full-page games might be suitable, we want to encourage builders to consider games built for the margins, footers, and headers of essays. Early 2000s online display advertising offers a wealth of examples for interactivity (remember Punch the Monkey!?).</p>
                            </div>
                            ...
                            <div className="accordion-panel">
                                <p>All software and game assets are released with individual copyright notices, otherwise, original author retains all copyright. We strongly encourage open source licences. Please include a copyright notice in your contest submission package.</p>
                            </div>
                            ...
                            <div className="accordion-panel">
                                <p>You can <a href="/about#donate">donate!</a> A little extra crypto would really help.</p>
                                <p>Or, <a href="/contact">reach out to the editors</a> to donate your time. We can use technical and non-technical help.</p>
                            </div>
