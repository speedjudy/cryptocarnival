        ...
        <div>
            ...
            <div className="container">
                <div className="footer-cta-area text-center active-shape hover-shape-inner">
                    <a className="theme-btn d-inline-block wow fadeInUp" href="javascript:void(0)" onClick={roll}>
                    ...
                    <div className="container">
                        ...
                        <div className="copyright-area text-center mb-0">
                            <p className="dsc mb-37">
                                ...
                                <a target="_blank" className="gafi" href="javascript:void(0)"> the Authors</a>
                            </p>
                        </div>
